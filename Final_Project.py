...
while boolean == 0:
    ...
    if answer == "1":
        ...
        instance_os = input("Please choose Operation System you wish to install:\n1. Ubuntu 18.04\n2. Your own AMI(if you have one)\n")
        if instance_os == "1":
        ...
        while o == 0:
            ...
            if pack == "1":
                ...
                # os.system("sshpass -p $passwd ssh root@$ip 'sudo apt-get install nginx'")


            # os.system('sshpass -p $passwd ssh root@$ip')